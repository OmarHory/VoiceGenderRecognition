...
Gender classification is a decent problem for someone who's on the door-step of learning in this tremendous field. Regardless of all the work that must be done prior to building your model; but most Machine Learning/ Deep Learning practitioners come together toward the impact of what Voice-Recognition can ease the life of others.
